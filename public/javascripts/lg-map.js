function fsmp(apath,aconf) {
  ...
  $.getScript( mapWrapper.data('map'), function() {
    ...
    //console.log("def"+config.defaultText)
    if(config.useText){
      ...
      for (var state in paths) {
        ...
        hitArea.mouseup(function(e) {
          ...
          if (paths[id].enable) {
            ...
            if (config.useText) {
              textArea.html(paths[id].text.toString());
              //console.log(paths[id].text+"");
            } else {
      ...
      for(var i = 0; i < pins.length; i++){
        ...
        pin.mouseup(function(e) {
          ...
          if (config.useText == true) {
            textArea.html(pins[id].text.replace(/["']/g, ""));
          } else {
